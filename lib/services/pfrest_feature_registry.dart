...
enum PfRestFeature {
  ...
  firewallAliasDelete,
  natPortForwardsRead,
  natPortForwardCreate,
  natPortForwardUpdate,
  natPortForwardDelete,
  natOneToOneRead,
  natOneToOneCreate,
  natOneToOneUpdate,
  natOneToOneDelete,
  natOutboundModeRead,
  natOutboundModeUpdate,
  natOutboundMappingsRead,
  natOutboundMappingCreate,
  natOutboundMappingUpdate,
  natOutboundMappingDelete,
}
...
const pfRestFeatureContracts = <PfRestFeature, PfRestFeatureContract>{
  ...
  PfRestFeature.natPortForwardsRead: PfRestFeatureContract(
    feature: PfRestFeature.natPortForwardsRead,
    label: 'NAT port forwards',
    path: '/api/v2/firewall/nat/port_forwards',
    method: 'GET',
    dependency: 'pfREST NAT port-forward endpoints',
    description: 'Lists NAT port-forward rules.',
  ),
  PfRestFeature.natPortForwardCreate: PfRestFeatureContract(
    feature: PfRestFeature.natPortForwardCreate,
    label: 'Create NAT port forward',
    path: '/api/v2/firewall/nat/port_forward',
    method: 'POST',
    dependency: 'pfREST NAT port-forward endpoints',
    description: 'Creates and applies a NAT port-forward rule.',
  ),
  PfRestFeature.natPortForwardUpdate: PfRestFeatureContract(
    feature: PfRestFeature.natPortForwardUpdate,
    label: 'Update NAT port forward',
    path: '/api/v2/firewall/nat/port_forward',
    method: 'PATCH',
    dependency: 'pfREST NAT port-forward endpoints',
    description: 'Updates and applies a NAT port-forward rule.',
  ),
  PfRestFeature.natPortForwardDelete: PfRestFeatureContract(
    feature: PfRestFeature.natPortForwardDelete,
    label: 'Delete NAT port forward',
    path: '/api/v2/firewall/nat/port_forward',
    method: 'DELETE',
    dependency: 'pfREST NAT port-forward endpoints',
    description: 'Deletes and applies a NAT port-forward rule.',
  ),
  PfRestFeature.natOneToOneRead: PfRestFeatureContract(
    feature: PfRestFeature.natOneToOneRead,
    label: '1:1 NAT mappings',
    path: '/api/v2/firewall/nat/one_to_one/mappings',
    method: 'GET',
    dependency: 'pfREST 1:1 NAT endpoints',
    description: 'Lists 1:1 NAT mappings.',
  ),
  PfRestFeature.natOneToOneCreate: PfRestFeatureContract(
    feature: PfRestFeature.natOneToOneCreate,
    label: 'Create 1:1 NAT mapping',
    path: '/api/v2/firewall/nat/one_to_one/mapping',
    method: 'POST',
    dependency: 'pfREST 1:1 NAT endpoints',
    description: 'Creates and applies a 1:1 NAT mapping.',
  ),
  PfRestFeature.natOneToOneUpdate: PfRestFeatureContract(
    feature: PfRestFeature.natOneToOneUpdate,
    label: 'Update 1:1 NAT mapping',
    path: '/api/v2/firewall/nat/one_to_one/mapping',
    method: 'PATCH',
    dependency: 'pfREST 1:1 NAT endpoints',
    description: 'Updates and applies a 1:1 NAT mapping.',
  ),
  PfRestFeature.natOneToOneDelete: PfRestFeatureContract(
    feature: PfRestFeature.natOneToOneDelete,
    label: 'Delete 1:1 NAT mapping',
    path: '/api/v2/firewall/nat/one_to_one/mapping',
    method: 'DELETE',
    dependency: 'pfREST 1:1 NAT endpoints',
    description: 'Deletes and applies a 1:1 NAT mapping.',
  ),
  PfRestFeature.natOutboundModeRead: PfRestFeatureContract(
    feature: PfRestFeature.natOutboundModeRead,
    label: 'Outbound NAT mode',
    path: '/api/v2/firewall/nat/outbound/mode',
    method: 'GET',
    dependency: 'pfREST outbound NAT mode endpoint',
    description: 'Reads automatic, hybrid, manual or disabled outbound NAT mode.',
  ),
  PfRestFeature.natOutboundModeUpdate: PfRestFeatureContract(
    feature: PfRestFeature.natOutboundModeUpdate,
    label: 'Change outbound NAT mode',
    path: '/api/v2/firewall/nat/outbound/mode',
    method: 'PATCH',
    dependency: 'pfREST outbound NAT mode endpoint',
    description: 'Changes and applies outbound NAT mode.',
  ),
  PfRestFeature.natOutboundMappingsRead: PfRestFeatureContract(
    feature: PfRestFeature.natOutboundMappingsRead,
    label: 'Outbound NAT mappings',
    path: '/api/v2/firewall/nat/outbound/mappings',
    method: 'GET',
    dependency: 'pfREST outbound NAT mapping endpoints',
    description: 'Lists manual outbound NAT mappings.',
  ),
  PfRestFeature.natOutboundMappingCreate: PfRestFeatureContract(
    feature: PfRestFeature.natOutboundMappingCreate,
    label: 'Create outbound NAT mapping',
    path: '/api/v2/firewall/nat/outbound/mapping',
    method: 'POST',
    dependency: 'pfREST outbound NAT mapping endpoints',
    description: 'Creates and applies an outbound NAT mapping.',
  ),
  PfRestFeature.natOutboundMappingUpdate: PfRestFeatureContract(
    feature: PfRestFeature.natOutboundMappingUpdate,
    label: 'Update outbound NAT mapping',
    path: '/api/v2/firewall/nat/outbound/mapping',
    method: 'PATCH',
    dependency: 'pfREST outbound NAT mapping endpoints',
    description: 'Updates and applies an outbound NAT mapping.',
  ),
  PfRestFeature.natOutboundMappingDelete: PfRestFeatureContract(
    feature: PfRestFeature.natOutboundMappingDelete,
    label: 'Delete outbound NAT mapping',
    path: '/api/v2/firewall/nat/outbound/mapping',
    method: 'DELETE',
    dependency: 'pfREST outbound NAT mapping endpoints',
    description: 'Deletes and applies an outbound NAT mapping.',
  ),
};
